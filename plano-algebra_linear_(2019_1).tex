...
\noindent {\bf{SISTEMA DE AVALIA\c{C}\~AO:}} Ser\~ao realizadas tr\^es prova cada uma valendo 10 pontos, as quais s\~ao atribu{\'\i}das as notas $P_1$, $P_2$ e $P_3$, nas datas detalhadas a seguir.
