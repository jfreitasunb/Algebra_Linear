...
\begin{exercicio}
  Sejam $V$ um $\cp{K}$-espaço vetorial e $S \sub V $ um subconjunto não vazio de $V$. Mostre que $S$ é um subespaço vetorial de $V$ se, e somente se, $S + S \sub S$ e $\lambda S \sub S$ para cada $\lambda \in \cp{K}$.
\end{exercicio}
