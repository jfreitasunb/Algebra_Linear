...
\begin{exercicio}
  ...
  \[
    ...
    \end{bmatrix}
  \]
  uma matriz $2 \times 2$ com elementos complexos. Suponhamos que $A$ seja linha-reduzida e tamb\'em que $a + b + c + d = 0$. Mostre que existem exatamente tr\^es destas matrizes.
\end{exercicio}
