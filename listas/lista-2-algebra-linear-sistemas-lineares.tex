...
\usepackage{graphicx}
\graphicspath{{/home/jfreitas/GitHub/Algebra_Linear/Pictures/}{C:/Users/josea/GitHub/Algebra_Linear/Pictures/}}
\usepackage{enumitem}
\usepackage{multicol}
 \usepackage{answers}
...
{\Large\bf \'Algebra Linear - Turma A -- 1$^{o}$/2019} \\ \vspace{9pt} {\large\bf
  $2^{\underline{a}}$ Lista de Exerc{\'\i}cios -- Sistema Lineares e Matrizes Inversas}\\ \vspace{9pt} Prof. Jos{\'e} Ant{\^o}nio O. Freitas
\end{center}
\hrule
