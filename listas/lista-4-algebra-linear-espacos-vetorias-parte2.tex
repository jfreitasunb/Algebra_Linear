...
\begin{exercicio}
  Sejam $W_1$ e $W_2$  subespaços de um $\cp{K}$-espa\c{c}o vetorial $V$. Defina
  \[
...
\begin{exercicio}
  Seja
  \[
    \mathcal{C}[0,1] = \{ f : [0,1] \to \real \mid f \mbox{ é contínua}\}
  \]
  um $\real$-espaço vetorial. Defina
  \[
  ...
  \end{align*}
  Mostre que $W_1$ e $W_2$ são subespaços vetoriais de $\mathcal{C}[0,1]$.
\end{exercicio}
\begin{exercicio}
...
\begin{exercicio}
  Em $\real^4$ seja $W_1$ o subespaço gerado por $(1,1,1,0)$ e $(0,-4,1,5)$ e seja $W_2$ o subespaço gerado por $(0,-2,1,2)$ e $(1,-1,1,3)$. Determine $\dim_\real(W_1 + W_1)$ e $\dim_\real(W_1 \cap W_2)$.
\end{exercicio}
...
\begin{exercicio}
  No $\real$-espaço vetorial $\real^4$, considere o subespaço $V$ dado pelas soluções do sistema linear
  \[
    \begin{cases}
      x + 2y + z = 0\\
      -x -y + 3t = 0
