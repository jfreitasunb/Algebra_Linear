...
\begin{exercicio}
  ...
  \begin{enumerate}[label=({\alph*})]
    ...
    \item $[T]_\mathcal{B} = \begin{bmatrix} -1 & -2 & 0\\ \phantom{-} 0 & -1 & 1\\ \phantom{-} 1 & \phantom{-} 0 & 0\end{bmatrix}$, $\cp{K} = \real$, $\complex$, $n = 3$
    ...
    \item $[T]_\mathcal{B} = \begin{bmatrix} 14 & -28 & -44\\ -7 & -14 & -23\\ 9 & 18 & 29\end{bmatrix}$, $\cp{K} = \real$, $n = 3$
  \end{enumerate}
  \begin{solucao}
      \begin{enumerate}[label=({\alph*})]
          ...
          \item Sobre $\real$ o operador $T$ n\~ao \'e diagonaliz\'avel. Sobre $\complex$, a base que diagonaliza $T$ \'e $\mathcal{A} = \{(2,1,-1);(-1 + i, 1, 1 + i);(-1 - i, 1, 1 - i)\}$; $[T]_\mathcal{A} = \begin{bmatrix} -2 & 0 & \phantom{-} 0\\ \phantom{-} 0 & i & \phantom{-} 0\\ \phantom{-} 0 & 0 & -i\end{bmatrix}$
          ...
          \item $\mathcal{A} = \{(-8,-1,3);(-2,1,0);(-1,-1,1)\}$; $[T]_\mathcal{A} = \begin{bmatrix} -1 & 0 & 0\\ 0 & 0 & 0\\ 0 & 0 & -2\end{bmatrix}$
        \end{enumerate}
  \end{solucao}
\end{exercicio}
