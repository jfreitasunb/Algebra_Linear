...
\begin{exercicio}
  ...
  \begin{enumerate}[label=({\alph*})]
    \item $F : \mathcal{P}_2(\real) \to \mathcal{P}_2(\real)$ dada por $F(p(t)) = t^2p''(t)$. Considere $\mathcal{P}_2(\real)$ um $\real$-espa\c{c}o vetorial.
    
    \item $D : \mathcal{P}_2(\complex) \to \mathcal{P}_2(\complex)$ dada por
    \[
      D(a_0 + a_1x + a_2x^2) = a_1 + 2a_2x.
    \]
    Considere $\mathcal{P}_2(\complex)$ um $\complex$-espa\c{c}o vetorial.
    
    \item $D : \mathcal{P}_5(\real) \to \mathcal{P}_5(\real)$ dada por
    \[
      D(a_0 + a_1x + a_2x^2 + a_3x^3 + a_4x^4 + a_5x^5) = a_1 + 2a_2x + 3a_3x^2 + 4a_4x^3 + 5a_5x^4
    \]
    Considere $\mathcal{P}_5(\real)$ um $\real$-espa\c{c}o vetorial.
