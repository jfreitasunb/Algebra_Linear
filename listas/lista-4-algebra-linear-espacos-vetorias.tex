...
\begin{exercicio}
  ...
  \begin{enumerate}[label={\alph*})]
    ...
    \]
    Assim $\mathcal{P}_m(\cp{K})$ \'e um $\cp{K}$-espa\c{c}o vetorial.
...
\begin{exercicio}
  Ache uma base de $\cp{M}_{p \times q}(\complex)$ como um $\complex$-espa\c{c}o vetorial. Quantos elementos tem? E se considerarmos $\cp{M}_{p \times q}(\complex)$ como um $\real$-espa\c{c}o vetorial
\end{exercicio}
