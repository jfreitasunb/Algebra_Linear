...
\begin{definicao}
	...
	\[
		A = [T]_{\mathcal{B}_1,\mathcal_{B}_2}.
	\]
	No caso em que $V = W$ e $\mathcal{B}_1 = \mathcal{B}_2 = \mathcal{B}$, denotaremos $[T]_{\mathcal{B}_1,\mathcal_{B}_2}$ simplesmente por $[T]_\mathcal{B}$
\end{definicao}
